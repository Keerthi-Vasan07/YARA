...
_CACHE = {"timestamp": None, "trajectories": None}
...
def get_float_trajectories():
    ...
    with _CACHE_LOCK:
        ...
        if timestamp is not None and (now - timestamp).total_seconds() < ARGO_CACHE_SECONDS:
            return _CACHE["trajectories"]
